...
class LrcFile(object):
    ...
    def load_content(self, content: str, lrc_type: str) -> bool:
        ...
        :param content: The text of file.
        :param lrc_type: 'non' or 'romaji' or 'chinese'
        :return:
        """
    ...
    def load_file_path(self, path: str, lrc_type: str):
        """
    ...
    def get_content(self, lrc_type: str = 'non') -> str:
        """
    ...
    def save_to_lrc(self, save_path: str, lrc_type: str) -> bool:
        """
        Save as an LRC file
    ...
    def save_to_mrc(self, save_path: str) -> bool:
        non_text = self.get_content('non')
        romaji_text = self.get_content('romaji')
        chinese_text = self.get_content('chinese')
    ...
    def empty(self, lrc_type: str = 'non') -> bool:
        target_dict = self.__select_lrc_type(lrc_type)
        if not target_dict:
            return True
...
class KrcFile(LrcFile):
    ...
    def load_content(self, content: bytes, lrc_type: str = 'non'):
        """
    ...
    def load_file_path(self, path: str, lrc_type: str = 'non'):
